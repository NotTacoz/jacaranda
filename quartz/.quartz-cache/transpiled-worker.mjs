...
var Footer_default = /* @__PURE__ */ __name((opts) => {
  function Footer({ displayClass }) {
    ...
    return /* @__PURE__ */ jsxs17("footer", { class: `${displayClass ?? ""}`, children: [
      ...
      /* @__PURE__ */ jsx27("img", { src: "https://moe-counter.glitch.me/get/@NotTacoz" }),
...
var RecentNotes_default = /* @__PURE__ */ __name((userOpts) => {
  function RecentNotes({ allFiles, fileData, displayClass, cfg }) {
    ...
    return /* @__PURE__ */ jsxs18("div", { class: `recent-notes ${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsx30("h3", { children: opts.title }),
      /* @__PURE__ */ jsx30("ul", { class: "recent-ul", children: pages.slice(0, opts.limit).map((page) => {
        const title = page.frontmatter?.title;
        const tags = page.frontmatter?.tags ?? [];
        return /* @__PURE__ */ jsx30("li", { class: "recent-li", children: /* @__PURE__ */ jsxs18("div", { class: "section", children: [
          ...
          page.dates && /* @__PURE__ */ jsx30("p", { class: "meta", children: /* @__PURE__ */ jsx30(Date2, { date: getDate(cfg, page) }) }),
          /* @__PURE__ */ jsx30("ul", { class: "tags", children: tags.map((tag) => /* @__PURE__ */ jsx30("li", { children: /* @__PURE__ */ jsxs18(
            "a",
            {
              class: "internal tag-link",
              href: resolveRelative(fileData.slug, `tags/${tag}`),
      ...
      opts.linkToMore && remaining > 0 && /* @__PURE__ */ jsx30("p", { children: /* @__PURE__ */ jsxs18("a", { href: resolveRelative(fileData.slug, opts.linkToMore), children: [
        "See ",
        remaining,
        " more \u2192"
      ] }) })
