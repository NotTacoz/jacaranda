...
var alignmentTypes = [AlignmentType.Inline, AlignmentType.Right, AlignmentType.Below]
var WordCountType
...
var NovelWordCountPlugin = class extends import_obsidian2.Plugin {
        ...
        callback: () =>
          __async(this, null, function* () {
            ...
            this.settings.countType =
              countTypes[(countTypes.indexOf(this.settings.countType) + 1) % countTypes.length]
  ...
  getDataTypeLabel(counts, countType, abbreviateDescriptions) {
    ...
    const getPluralizedCount = function (noun, count, round = true) {
      ...
      const displayCount = round
        ...
        : roundedCount.toLocaleString(void 0, {
    ...
    switch (countType) {
      ...
      case CountType.PageDecimal:
        return abbreviateDescriptions
          ? `${counts.pageCount.toLocaleString(void 0, {
              minimumFractionDigits: 1,
              maximumFractionDigits: 2,
            })}p`
  ...
  getNodeLabel(counts) {
    ...
    return countTypes2
      ...
      .map((ct) => this.getDataTypeLabel(counts, ct, this.settings.abbreviateDescriptions))
  ...
  handleEvents() {
    return __async(this, null, function* () {
      this.registerEvent(
        this.app.vault.on("modify", (file) =>
          __async(this, null, function* () {
            ...
            yield this.fileHelper.updateFileCounts(
              file,
      ...
      const recalculateAll = (hookName, file) =>
        __async(this, null, function* () {
          if (file) {
            this.debugHelper.debug(
      ...
      const reshowCountsIfNeeded = (hookName) =>
        __async(this, null, function* () {
...
var NovelWordCountSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    const mainHeader = containerEl.createEl("div", {
      cls: ["setting-item", "setting-item-heading", "novel-word-count-settings-header"],
    })
    ...
    new import_obsidian2.Setting(containerEl)
      ...
      .addDropdown((drop) => {
        ...
        drop.setValue(this.plugin.settings.countType).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian2.Setting(containerEl)
      ...
      .addDropdown((drop) => {
        ...
        drop.setValue(this.plugin.settings.countType2).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian2.Setting(containerEl)
      ...
      .addDropdown((drop) => {
        ...
        drop.setValue(this.plugin.settings.countType3).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian2.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.abbreviateDescriptions).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian2.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.showSameCountsOnFolders).onChange((value) =>
          __async(this, null, function* () {
    ...
    if (!this.plugin.settings.showSameCountsOnFolders) {
      new import_obsidian2.Setting(containerEl)
        ...
        .addDropdown((drop) => {
          ...
          drop.setValue(this.plugin.settings.folderCountType).onChange((value) =>
            __async(this, null, function* () {
      ...
      new import_obsidian2.Setting(containerEl)
        ...
        .addDropdown((drop) => {
          ...
          drop.setValue(this.plugin.settings.folderCountType2).onChange((value) =>
            __async(this, null, function* () {
      ...
      new import_obsidian2.Setting(containerEl)
        ...
        .addDropdown((drop) => {
          ...
          drop.setValue(this.plugin.settings.folderCountType3).onChange((value) =>
            __async(this, null, function* () {
    ...
    new import_obsidian2.Setting(containerEl)
      ...
      .addDropdown((drop) => {
        drop
          .addOption(WordCountType.SpaceDelimited, "Space-delimited (European languages)")
    ...
    if (this.plugin.settings.pageCountType === PageCountType.ByWords) {
      const wordsPerPageChanged = (txt, value) =>
        __async(this, null, function* () {
      ...
      new import_obsidian2.Setting(containerEl)
        ...
        .setDesc("Used for page count. 300 is standard in English language publishing.")
        .addText((txt) => {
          txt
            .setPlaceholder("300")
            .setValue(this.plugin.settings.wordsPerPage.toString())
            .onChange((0, import_obsidian2.debounce)(wordsPerPageChanged.bind(this, txt), 1e3))
        })
    }
    if (this.plugin.settings.pageCountType === PageCountType.ByChars) {
      new import_obsidian2.Setting(containerEl)
        ...
        .addToggle((toggle) =>
          toggle.setValue(this.plugin.settings.charsPerPageIncludesWhitespace).onChange((value) =>
            __async(this, null, function* () {
      ...
      const charsPerPageChanged = (txt, value) =>
        __async(this, null, function* () {
          const asNumber = Number(value)
          const isValid = !isNaN(asNumber) && asNumber > 0
          txt.inputEl.style.borderColor = isValid ? null : "red"
      ...
      new import_obsidian2.Setting(containerEl)
        ...
        .addText((txt) => {
          txt
            ...
            .onChange((0, import_obsidian2.debounce)(charsPerPageChanged.bind(this, txt), 1e3))
        })
    }
    new import_obsidian2.Setting(containerEl)
