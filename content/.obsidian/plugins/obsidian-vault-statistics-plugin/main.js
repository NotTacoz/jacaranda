...
var ScalingUnitFormatter = /** @class */ (function (_super) {
  ...
  ScalingUnitFormatter.prototype.format = function (value) {
    var _a = this.scale(value),
      ...
      scaledUnit = _a[1];
    return ""
      .concat(this.numberFormat.format(scaledValue), " ")
      .concat(scaledUnit);
  };
...
var VaultMetrics = /** @class */ (function (_super) {
  ...
  VaultMetrics.prototype.dec = function (metrics) {
    this.files -=
      (metrics === null || metrics === void 0 ? void 0 : metrics.files) || 0;
    this.notes -=
      (metrics === null || metrics === void 0 ? void 0 : metrics.notes) || 0;
    this.attachments -=
      (metrics === null || metrics === void 0 ? void 0 : metrics.attachments) ||
      0;
    this.size -=
      (metrics === null || metrics === void 0 ? void 0 : metrics.size) || 0;
    this.links -=
      (metrics === null || metrics === void 0 ? void 0 : metrics.links) || 0;
    this.words -=
      (metrics === null || metrics === void 0 ? void 0 : metrics.words) || 0;
...
var VaultMetricsCollector = /** @class */ (function () {
  ...
  VaultMetricsCollector.prototype.push = function (fileOrPath) {
    ...
    var path =
      fileOrPath instanceof obsidian.TFile ? fileOrPath.path : fileOrPath;
  ...
  VaultMetricsCollector.prototype.getFileType = function (file) {
    var _a;
    if (
      ((_a = file.extension) === null || _a === void 0
        ? void 0
        : _a.toLowerCase()) === "md"
    ) {
      ...
      return __generator(this, function (_a) {
        ...
        switch (this.getFileType(file)) {
          case FileType.Note:
            return [
              2 /*return*/,
              new NoteMetricsCollector(this.vault).collect(file, metadata),
            ];
          case FileType.Attachment:
            return [
              2 /*return*/,
              new FileMetricsCollector().collect(file, metadata),
            ];
        }
        return [2 /*return*/];
      });
  ...
  VaultMetricsCollector.prototype.update = function (fileOrPath, metrics) {
    ...
    (_a = this.vaultMetrics) === null || _a === void 0
      ? void 0
      : _a.dec(this.data.get(key));
    if (metrics == null) {
      this.data.delete(key);
    } else {
      this.data.set(key, metrics);
    }
    (_b = this.vaultMetrics) === null || _b === void 0
      ? void 0
      : _b.inc(metrics);
  };
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            metrics.size =
              (_a = file.stat) === null || _a === void 0 ? void 0 : _a.size;
            metrics.links =
              ((_b =
                metadata === null || metadata === void 0
                  ? void 0
                  : metadata.links) === null || _b === void 0
                ? void 0
                : _b.length) || 0;
            metrics.words = 0;
            _c = metrics;
                        ...
                        .map(function (section) {
                          ...
                          var endOffset =
                            (_d =
                              ...
                              : _d.offset;
                          var tokenizer =
                            NoteMetricsCollector.TOKENIZERS.get(sectionType);
                          if (!tokenizer) {
                            console.log(
                              ""
                                .concat(
                                  file.path,
                                  ": no tokenizer, section.type=",
                                )
                                .concat(section.type),
                            );
                            return 0;
...
var StatisticsPluginSettingTab = /** @class */ (function (_super) {
  ...
  StatisticsPluginSettingTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "Whether to show multiple items at once or cycle them with a click",
      )
...
var StatisticsStatusBarItem = /** @class */ (function () {
  ...
  StatisticsStatusBarItem.prototype.refresh = function () {
    ...
    if (this.owner.settings.displayIndividualItems) {
      this.statisticViews[0]
        .setActive(this.owner.settings.showNotes)
        .refresh(this.vaultMetrics);
      this.statisticViews[1]
        .setActive(this.owner.settings.showAttachments)
        .refresh(this.vaultMetrics);
      this.statisticViews[2]
        .setActive(this.owner.settings.showFiles)
        .refresh(this.vaultMetrics);
      this.statisticViews[3]
        .setActive(this.owner.settings.showLinks)
        .refresh(this.vaultMetrics);
      this.statisticViews[4]
        .setActive(this.owner.settings.showWords)
        .refresh(this.vaultMetrics);
      this.statisticViews[5]
        .setActive(this.owner.settings.showSize)
        .refresh(this.vaultMetrics);
    } else {
      this.statisticViews.forEach(function (view, i) {
        view
          .setActive(_this.displayedStatisticIndex == i)
          .refresh(_this.vaultMetrics);
      });
    }
  ...
  StatisticsStatusBarItem.prototype.onclick = function () {
    if (!this.owner.settings.displayIndividualItems) {
      this.displayedStatisticIndex =
        (this.displayedStatisticIndex + 1) % this.statisticViews.length;
    }
    this.refresh();
  };
