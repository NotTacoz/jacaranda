    ...
    if (content.trim() === "") {
      ...
      var words = content
        ...
        .filter(function (token) {
          return !_this.isNonWord(token)
        })
        .filter(function (token) {
          return !_this.isNumber(token)
        })
        .filter(function (token) {
          return !_this.isCodeBlockHeader(token)
        })
        .map(function (token) {
          return _this.stripAll(token)
        })
        .filter(function (token) {
...
var VaultMetricsCollector = /** @class */ (function () {
  ...
  VaultMetricsCollector.prototype.start = function () {
    ...
    this.owner.registerEvent(
      this.vault.on("create", function (file) {
        _this.onfilecreated(file)
      }),
    )
    this.owner.registerEvent(
      this.vault.on("modify", function (file) {
        _this.onfilemodified(file)
      }),
    )
    this.owner.registerEvent(
      this.vault.on("delete", function (file) {
        _this.onfiledeleted(file)
      }),
    )
    this.owner.registerEvent(
      this.vault.on("rename", function (file, oldPath) {
        _this.onfilerenamed(file, oldPath)
      }),
    )
    this.owner.registerEvent(
      this.metadataCache.on("resolve", function (file) {
        _this.onfilemodified(file)
      }),
    )
    this.owner.registerEvent(
      this.metadataCache.on("changed", function (file) {
        _this.onfilemodified(file)
      }),
    )
    this.data.clear()
    ...
    this.owner.registerInterval(
      +setInterval(function () {
        _this.processBacklog()
      }, 2000),
    )
    return this
  }
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ...
            metrics.links =
              ((_b = metadata === null || metadata === void 0 ? void 0 : metadata.links) === null ||
              _b === void 0
                ? void 0
                : _b.length) || 0
            metrics.words = 0
            ...
            return [
              ...
              this.vault
                ...
                .then(function (content) {
                  var _a
                  return (_a = metadata.sections) === null || _a === void 0
                    ? void 0
                    : _a
                        .map(function (section) {
                          ...
                          var startOffset =
                            (_b =
                              (_a = section.position) === null || _a === void 0
                                ? void 0
                          ...
                          var endOffset =
                            (_d =
                              (_c = section.position) === null || _c === void 0
                                ? void 0
                                : _c.end) === null || _d === void 0
                              ? void 0
                              : _d.offset
                          ...
                          if (!tokenizer) {
                            console.log(
                              ""
                                .concat(file.path, ": no tokenizer, section.type=")
                                .concat(section.type),
                            )
                            return 0
                          } else {
  ...
  StatisticsPluginSettingTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (value) {
        value.setValue(_this.plugin.settings.displayIndividualItems).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl).setName("Show notes").addToggle(function (value) {
      value.setValue(_this.plugin.settings.showNotes).onChange(function (value) {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
    ...
    new obsidian.Setting(containerEl).setName("Show attachments").addToggle(function (value) {
      value.setValue(_this.plugin.settings.showAttachments).onChange(function (value) {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
    ...
    new obsidian.Setting(containerEl).setName("Show files").addToggle(function (value) {
      value.setValue(_this.plugin.settings.showFiles).onChange(function (value) {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
    ...
    new obsidian.Setting(containerEl).setName("Show links").addToggle(function (value) {
      value.setValue(_this.plugin.settings.showLinks).onChange(function (value) {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
    ...
    new obsidian.Setting(containerEl).setName("Show words").addToggle(function (value) {
      value.setValue(_this.plugin.settings.showWords).onChange(function (value) {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
    ...
    new obsidian.Setting(containerEl).setName("Show size").addToggle(function (value) {
      value.setValue(_this.plugin.settings.showSize).onChange(function (value) {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            this.vaultMetricsCollector = new VaultMetricsCollector(this)
              ...
              .start()
            this.statusBarItem = new StatisticsStatusBarItem(
              this,
...
var StatisticView = /** @class */ (function () {
  ...
  function StatisticView(containerEl) {
    this.containerEl = containerEl.createSpan({
      cls: ["obsidian-vault-statistics--item"],
    })
...
var StatisticsStatusBarItem = /** @class */ (function () {
  function StatisticsStatusBarItem(owner, statusBarItem) {
    ...
    this.statisticViews = []
    this.refreshSoon = obsidian.debounce(
      function () {
        _this.refresh()
      },
      2000,
    ...
    this.statisticViews.push(
      new StatisticView(this.statusBarItem).setStatisticName("notes").setFormatter(function (s) {
        return new DecimalUnitFormatter("notes").format(s.notes)
      }),
    )
    this.statisticViews.push(
      new StatisticView(this.statusBarItem)
        .setStatisticName("attachments")
        .setFormatter(function (s) {
          return new DecimalUnitFormatter("attachments").format(s.attachments)
        }),
    )
    this.statisticViews.push(
      new StatisticView(this.statusBarItem).setStatisticName("files").setFormatter(function (s) {
        return new DecimalUnitFormatter("files").format(s.files)
      }),
    )
    this.statisticViews.push(
      new StatisticView(this.statusBarItem).setStatisticName("links").setFormatter(function (s) {
        return new DecimalUnitFormatter("links").format(s.links)
      }),
    )
    this.statisticViews.push(
      new StatisticView(this.statusBarItem).setStatisticName("words").setFormatter(function (s) {
        return new DecimalUnitFormatter("words").format(s.words)
      }),
    )
    this.statisticViews.push(
      new StatisticView(this.statusBarItem).setStatisticName("size").setFormatter(function (s) {
        return new BytesFormatter().format(s.size)
      }),
    )
    this.statusBarItem.onClickEvent(function () {
      _this.onclick()
    })
  }
  StatisticsStatusBarItem.prototype.setVaultMetrics = function (vaultMetrics) {
    ...
    this.vaultMetrics = vaultMetrics
    this.owner.registerEvent(
      (_a = this.vaultMetrics) === null || _a === void 0
        ? void 0
        : _a.on("updated", this.refreshSoon),
    )
    this.refreshSoon()
    return this
  }
  StatisticsStatusBarItem.prototype.refresh = function () {
    ...
    if (this.owner.settings.displayIndividualItems) {
      ...
      this.statisticViews[1]
        .setActive(this.owner.settings.showAttachments)
        .refresh(this.vaultMetrics)
    ...
    this.statusBarItem.title = this.statisticViews
      .map(function (view) {
        return view.getText()
      })
      .join("\n")
