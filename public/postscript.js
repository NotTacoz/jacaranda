...
(function () {
      ...
      (function _f(self) {
        ...
        function K(a2, b2) {
          ...
          if (a2) {
            x(a2)
              ? (a2 = qa[a2])
              : (c2 = a2.preset) && (a2 = Object.assign({}, c2[c2], a2));
            c2 = a2.charset;
            var d2 = a2.lang;
            x(c2) &&
              (-1 === c2.indexOf(":") && (c2 += ":default"), (c2 = G[c2]));
            x(d2) && (d2 = ka[d2]);
          } else a2 = {};
          let e,
            f,
                  ...
                  switch (this.G) {
                    ...
                    case "forward":
                      if (1 < e) {
                        for (h = 0; h < e; h++)
                          (g += l[h]),
                            g.length >= this.B && M(this, n, g, f, a2, c2);
                        break;
                      }
                    default:
                      if (
                        (this.C &&
                          (f = Math.min((f / this.C(b2, l, r)) | 0, q - 1)),
                        M(this, n, l, f, a2, c2),
                        w && 1 < d2 && r < d2 - 1)
                      ) {
                        for (
          ...
          if (!b2[c2] || (g && !b2[c2][g]))
            a2.s && (h = h[d2]),
              ...
              (f && -1 !== h.indexOf(e)) ||
                ((h[h.length] = e),
                a2.m &&
                  ((a2 = a2.register[e] || (a2.register[e] = [])),
                  (a2[a2.length] = h)));
        }
        t.search = function (a2, b2, c2) {
          c2 ||
            (!b2 && C(a2) ? ((c2 = a2), (a2 = c2.query)) : C(b2) && (c2 = b2));
          let d2 = [],
            e;
          let f,
            g = 0;
        ...
        t.remove = function (a2, b2) {
          ...
          if (c2) {
            if (this.m)
              ...
              N(this.map, a2, this.D, this.s),
                this.depth && N(this.h, a2, this.A, this.s);
            ...
            if (this.cache) {
              ...
              for (let d2 = 0, e, f; d2 < b2.h.length; d2++)
                (f = b2.h[d2]),
                  (e = b2.cache[f]),
                  -1 !== e.indexOf(a2) &&
                    (b2.h.splice(d2--, 1), delete b2.cache[f]);
            }
          }
          return this;
        };
        function N(a2, b2, c2, d2, e) {
          ...
          if (a2.constructor === Array)
            if (e)
              (b2 = a2.indexOf(b2)),
                -1 !== b2 ? 1 < a2.length && (a2.splice(b2, 1), f++) : f++;
            else {
        ...
        function va(a2) {
          ...
          switch (d2) {
            case "init":
              ...
              d2.cache = false;
              b2 &&
                0 === b2.indexOf("function") &&
                (d2.encode = Function("return " + b2)());
              a2
        ...
        t.remove = function (a2) {
          ...
          if (this.register[a2]) {
            for (
              var b2 = 0;
              b2 < this.h.length &&
              (this.index[this.h[b2]].remove(a2, !this.o), !this.m);
              b2++
            );
            if (this.I && !this.m)
              for (let c2 in this.l) {
                ...
                -1 !== d2 &&
                  (1 < b2.length ? b2.splice(d2, 1) : delete this.l[c2]);
              }
  ...
  function highlight(searchTerm, text, trim) {
    ...
    if (trim) {
      ...
      for (
        ...
        const windowSum = window2.reduce(
  ...
  document.addEventListener("nav", async (e) => {
    ...
    async function onType(e2) {
      ...
      const searchResults =
        (await index?.searchAsync(term, numSearchResults)) ?? [];
...
(function () {
  ...
  function drag_default() {
    ...
    function touchstarted(event, d) {
      ...
      var touches = event.changedTouches,
        c2 = container.call(this, event, d),
        n = touches.length,
        i,
        gesture;
      for (i = 0; i < n; ++i) {
    ...
    drag.filter = function (_) {
      return arguments.length
        ? ((filter2 = typeof _ === "function" ? _ : constant_default2(!!_)),
          drag)
        : filter2;
    };
    drag.container = function (_) {
      return arguments.length
        ? ((container = typeof _ === "function" ? _ : constant_default2(_)),
          drag)
        : container;
    };
    ...
    return (m2 = reHex.exec(format))
      ? ((l = m2[1].length),
        ...
        l === 6
          ...
          : null)
      : (m2 = reRgbInteger.exec(format))
      ? new Rgb(m2[1], m2[2], m2[3], 1)
      : (m2 = reRgbPercent.exec(format))
      ? new Rgb(
          (m2[1] * 255) / 100,
          (m2[2] * 255) / 100,
          (m2[3] * 255) / 100,
      ...
      : (m2 = reRgbaInteger.exec(format))
      ? rgba(m2[1], m2[2], m2[3], m2[4])
      : (m2 = reRgbaPercent.exec(format))
      ? rgba(
          (m2[1] * 255) / 100,
          (m2[2] * 255) / 100,
          (m2[3] * 255) / 100,
      ...
      : (m2 = reHslPercent.exec(format))
      ? hsla(m2[1], m2[2] / 100, m2[3] / 100, 1)
      : (m2 = reHslaPercent.exec(format))
      ? hsla(m2[1], m2[2] / 100, m2[3] / 100, m2[4])
  ...
  function rgb_formatRgb() {
    ...
    return `${a2 === 1 ? "rgb(" : "rgba("}${clampi(this.r)}, ${clampi(
      this.g,
    )}, ${clampi(this.b)}${a2 === 1 ? ")" : `, ${a2})`}`;
  }
  ...
  define_default(
    ...
    extend(Color, {
      ...
      formatHsl() {
        const a2 = clampa(this.opacity);
        return `${a2 === 1 ? "hsl(" : "hsla("}${clamph(this.h)}, ${
          clampt(this.s) * 100
        }%, ${clampt(this.l) * 100}%${a2 === 1 ? ")" : `, ${a2})`}`;
      },
    }),
  );
  ...
  function gamma(y2) {
    return (y2 = +y2) === 1
      ...
      : function (a2, b) {
          return b - a2
            ? exponential(a2, b, y2)
            : constant_default3(isNaN(a2) ? b : a2);
        };
  }
  ...
  function parseCss(value) {
    ...
    return m2.isIdentity
      ? identity
      : decompose_default(m2.a, m2.b, m2.c, m2.d, m2.e, m2.f);
  }
  ...
  function center_default(x2, y2) {
    ...
    function force() {
      ...
      for (
        sx = (sx / n - x2) * strength, sy = (sy / n - y2) * strength, i = 0;
        i < n;
        ++i
      ) {
  ...
  function addAll(data) {
    ...
    for (i = 0; i < n; ++i) {
      if (
        isNaN((x2 = +this._x.call(null, (d = data[i])))) ||
        isNaN((y2 = +this._y.call(null, d)))
      )
        continue;
      xz[i] = x2;
      yz[i] = y2;
  ...
  function visit_default(callback) {
    ...
    if (node)
      quads.push(
        new quad_default(node, this._x0, this._y0, this._x1, this._y1),
      );
    while ((q = quads.pop())) {
      if (
        !callback(
  ...
  function link_default(links) {
    ...
    force.strength = function (_) {
      return arguments.length
        ? ((strength = typeof _ === "function" ? _ : constant_default5(+_)),
          initializeStrength(),
          force)
        : strength;
    };
    force.distance = function (_) {
      return arguments.length
        ? ((distance = typeof _ === "function" ? _ : constant_default5(+_)),
          initializeDistance(),
          force)
        : distance;
    };
  ...
  Transform.prototype = {
    ...
    translate: function (x2, y2) {
      return (x2 === 0) & (y2 === 0)
        ? this
        : new Transform(this.k, this.x + this.k * x2, this.y + this.k * y2);
    },
    ...
    rescaleX: function (x2) {
      return x2
        .copy()
        .domain(x2.range().map(this.invertX, this).map(x2.invert, x2));
    },
    rescaleY: function (y2) {
      return y2
        .copy()
        .domain(y2.range().map(this.invertY, this).map(y2.invert, y2));
    },
    toString: function () {
  ...
  function zoom_default2() {
    ...
    zoom.transform = function (collection, transform2, point, event) {
      var selection2 = collection.selection
    ...
    function scale(transform2, k) {
      ...
      return k === transform2.k
        ? transform2
        : new Transform(k, transform2.x, transform2.y);
    }
    function translate(transform2, p0, p1) {
      var x2 = p0[0] - p1[0] * transform2.k,
        y2 = p0[1] - p1[1] * transform2.k;
      return x2 === transform2.x && y2 === transform2.y
        ? transform2
        : new Transform(transform2.k, x2, y2);
    }
    ...
    zoom.wheelDelta = function (_) {
      return arguments.length
        ? ((wheelDelta = typeof _ === "function" ? _ : constant_default6(+_)),
          zoom)
        : wheelDelta;
    };
    zoom.filter = function (_) {
      return arguments.length
        ? ((filter2 = typeof _ === "function" ? _ : constant_default6(!!_)),
          zoom)
        : filter2;
    };
    zoom.touchable = function (_) {
      return arguments.length
        ? ((touchable = typeof _ === "function" ? _ : constant_default6(!!_)),
          zoom)
        : touchable;
    };
  ...
  async function renderGraph(container, fullSlug) {
    ...
    const simulation = simulation_default(graphData.nodes)
      .force("charge", manyBody_default().strength(-100 * repelForce))
      .force(
        "link",
        link_default(graphData.links)
          .id((d) => d.id)
    ...
    const drag = (simulation2) => {
      ...
      const noop2 = () => {};
      return drag_default()
        .on("start", enableDrag ? dragstarted : noop2)
        .on("drag", enableDrag ? dragged : noop2)
        .on("end", enableDrag ? dragended : noop2);
    };
    ...
    const node = graphNode
      ...
      .on("mouseover", function (_, d) {
        ...
        const neighbourNodes = selectAll_default2(".node").filter((d2) =>
          neighbours.includes(d2.id),
        );
        const currentId = d.id;
        const linkNodes = selectAll_default2(".link").filter(
          (d2) => d2.source.id === currentId || d2.target.id === currentId,
        );
        ...
        select_default2(parent)
          ...
          .attr(
            "opacityOld",
            select_default2(parent).select("text").style("opacity"),
          )
          .style("opacity", 1)
      ...
      .on("mouseleave", function (_, d) {
        ...
        select_default2(parent)
          ...
          .style(
            "opacity",
            select_default2(parent).select("text").attr("opacityOld"),
          )
    ...
    const labels = graphNode
      ...
      .text(
        (d) =>
          data[d.id]?.title ||
          (
            d.id.charAt(0).toUpperCase() + d.id.slice(1, d.id.length - 1)
          ).replace("-", " "),
      )
...
(function () {
  ...
  async function c(t2, e2) {
    ...
    const {
      ...
      } = t2,
      {
        ...
        altBoundary: p4 = false,
        padding: h3 = 0,
      } = a(e2, t2),
      y2 = l(h3),
      x3 = f3[p4 ? ("floating" === d3 ? "reference" : "floating") : d3],
      w3 = s(
        await r3.getClippingRect({
          element:
            null ==
              (n3 = await (null == r3.isElement ? void 0 : r3.isElement(x3))) ||
            n3
              ? x3
              : x3.contextElement ||
                (await (null == r3.getDocumentElement
                  ? void 0
      ...
      v3 = "floating" === d3 ? { ...c3.floating, x: o3, y: i3 } : c3.reference,
      b3 = await (null == r3.getOffsetParent
        ? void 0
        : r3.getOffsetParent(f3.floating)),
      A3 = ((await (null == r3.isElement ? void 0 : r3.isElement(b3))) &&
        (await (null == r3.getScale ? void 0 : r3.getScale(b3)))) || {
        x: 1,
        y: 1,
      },
      R2 = s(
    ...
    return {
      top: (w3.top - R2.top + y2.top) / A3.y,
      bottom: (R2.bottom - w3.bottom + y2.bottom) / A3.y,
      left: (w3.left - R2.left + y2.left) / A3.x,
      right: (R2.right - w3.right + y2.right) / A3.x,
    };
  }
  var f = Math.min;
  var m = Math.max;
        ...
        async fn(o3) {
          ...
          const {
            ...
            } = o3,
            {
              mainAxis: g3 = true,
              crossAxis: d3 = true,
              fallbackPlacements: p4,
              fallbackStrategy: h3 = "bestFit",
              fallbackAxisSideDirection: w3 = "none",
              flipAlignment: b3 = true,
              ...A3
            } = a(e2, o3),
            R2 = n(r3),
            P2 = n(f3) === f3,
            E3 = await (null == m3.isRTL ? void 0 : m3.isRTL(u3.floating)),
            T3 =
              p4 ||
              (P2 || !b3
                ? [y(f3)]
          ...
          if (
            ...
            var B3, C3;
            const t2 = ((null == (B3 = l3.flip) ? void 0 : B3.index) || 0) + 1,
              e3 = D3[t2];
            if (e3)
              return {
  ...
  function T(t2) {
    const e2 = f(...t2.map((t3) => t3.left)),
      n3 = f(...t2.map((t3) => t3.top));
    return {
      x: e2,
      y: n3,
      width: m(...t2.map((t3) => t3.right)) - e2,
      height: m(...t2.map((t3) => t3.bottom)) - n3,
    };
  }
  var D = function (t2) {
    return (
      void 0 === t2 && (t2 = {}),
      {
        ...
        async fn(e2) {
          const {
            ...
            { padding: d3 = 2, x: p4, y: h3 } = a(t2, e2),
            y2 = Array.from(
              (await (null == u3.getClientRects
                ? void 0
                : u3.getClientRects(r3.reference))) || [],
            ),
            x3 = (function (t3) {
              const e3 = t3.slice().sort((t4, e4) => t4.y - e4.y),
                n3 = [];
              let o3 = null;
              for (let t4 = 0; t4 < e3.length; t4++) {
                const i4 = e3[t4];
                !o3 || i4.y - o3.y > o3.height / 2
                  ? n3.push([i4])
                  : n3[n3.length - 1].push(i4),
                  (o3 = i4);
              }
            ...
            w3 = s(T(y2)),
            v3 = l(d3);
          const b3 = await u3.getElementRects({
            reference: {
              getBoundingClientRect: function () {
                if (
                  2 === x3.length &&
                  x3[0].left > x3[1].right &&
                  null != p4 &&
                  null != h3
                )
                  return (
                    x3.find(
                      (t3) =>
                        p4 > t3.left - v3.left &&
                        p4 < t3.right + v3.right &&
                        h3 > t3.top - v3.top &&
                        h3 < t3.bottom + v3.bottom,
                    ) || w3
                  );
                if (x3.length >= 2) {
                  if ("x" === o(i3)) {
                  ...
                  const t3 = "left" === n(i3),
                    e3 = m(...x3.map((t4) => t4.right)),
                    r4 = f(...x3.map((t4) => t4.left)),
                    a3 = x3.filter((n3) =>
                      t3 ? n3.left === r4 : n3.right === e3,
                    ),
                    l3 = a3[0].top,
                    s3 = a3[a3.length - 1].bottom;
                  return {
                    top: l3,
                    bottom: s3,
                    left: r4,
          ...
          return c3.reference.x !== b3.reference.x ||
            c3.reference.y !== b3.reference.y ||
            c3.reference.width !== b3.reference.width ||
            c3.reference.height !== b3.reference.height
            ? { reset: { rects: b3 } }
            : {};
        },
      }
  ...
  var O = function (t2) {
    return (
      void 0 === t2 && (t2 = {}),
      {
        ...
        options: t2,
        async fn(e2) {
          const { x: i3, y: r3, placement: l3 } = e2,
            {
              mainAxis: s3 = true,
              crossAxis: f3 = false,
              limiter: m3 = {
  ...
  function n2(t2) {
    var e2;
    return (
      (null == (e2 = t2.ownerDocument) ? void 0 : e2.defaultView) || window
    );
  }
  function o2(t2) {
  ...
  function a2(t2) {
    ...
    return (
      "none" !== n3.transform ||
      "none" !== n3.perspective ||
      (!!n3.containerType && "normal" !== n3.containerType) ||
      (!e2 && !!n3.backdropFilter && "none" !== n3.backdropFilter) ||
  ...
  function b2(t2) {
    ...
    const n3 = e2.getBoundingClientRect(),
      { width: o3, height: i3, $: r3 } = x2(e2);
    let l3 = (r3 ? g2(n3.width) : n3.width) / o3,
      s3 = (r3 ? g2(n3.height) : n3.height) / i3;
    return (
  ...
  function T2(t2, e2, o3) {
    ...
    return !o3 || (e2 && o3 !== c3)
      ? L2
      : {
          x: (null == (i3 = c3.visualViewport) ? void 0 : i3.offsetLeft) || 0,
          y: (null == (r3 = c3.visualViewport) ? void 0 : r3.offsetTop) || 0,
        };
  }
  function R(e2, o3, i3, r3) {
    void 0 === o3 && (o3 = false), void 0 === i3 && (i3 = false);
    const c3 = e2.getBoundingClientRect(),
      s3 = v2(e2);
    let f3 = w2(1);
    o3 && (r3 ? l2(r3) && (f3 = b2(r3)) : (f3 = b2(e2)));
    const u3 = T2(s3, i3, r3);
    let a3 = (c3.left + u3.x) / f3.x,
      d3 = (c3.top + u3.y) / f3.y,
      h3 = c3.width / f3.x,
      p4 = c3.height / f3.y;
    if (s3) {
      const t2 = n2(s3),
        e3 = r3 && l2(r3) ? n2(r3) : r3;
  ...
  function S(t2) {
    return ((i2(t2) ? t2.ownerDocument : t2.document) || window.document)
      .documentElement;
  }
  function E2(t2) {
    return l2(t2)
  ...
  function D2(t2, e2) {
    ...
    const i3 = O2(t2),
      ...
      c3 = n2(i3);
    return r3
      ? e2.concat(c3, c3.visualViewport || [], f2(i3) ? i3 : [])
      : e2.concat(i3, D2(i3));
  }
  function W(e2, i3, r3) {
    let s3;
    if ("viewport" === i3)
      s3 = (function (t2, e3) {
        ...
        if (r4) {
          ...
          const t3 = d2();
          (!t3 || (t3 && "fixed" === e3)) &&
            ((s4 = r4.offsetLeft), (f3 = r4.offsetTop));
        }
      ...
      s3 = (function (t2) {
        ...
        return (
          "rtl" === o2(i4).direction &&
            (l3 += m2(e3.clientWidth, i4.clientWidth) - r4),
          { width: r4, height: c3, x: l3, y: s4 }
        );
      })(S(e2));
    else if (l2(i3))
      s3 = (function (t2, e3) {
        const n3 = R(t2, true, "fixed" === e3),
  ...
  function H(t2, e2) {
    ...
    return (
      !(n3 === e2 || !l2(n3) || h2(n3)) &&
      ("fixed" === o2(n3).position || H(n3, e2))
    );
  }
  function z(t2, e2) {
    return c2(t2) && "fixed" !== o2(t2).position
      ? e2
        ? e2(t2)
        : t2.offsetParent
      : null;
  ...
  function M(t2, e2) {
    ...
    return l3 &&
      ("html" === r2(l3) ||
        ("body" === r2(l3) && "static" === o2(l3).position && !a2(l3)))
      ? i3
      : l3 ||
          (function (t3) {
            let e3 = F(t3);
  ...
  function P(t2, e2, n3) {
    ...
    return {
      x: s3.left + u3.scrollLeft - a3.x,
      y: s3.top + u3.scrollTop - a3.y,
      width: s3.width,
      height: s3.height,
    };
  }
  var A2 = {
    getClippingRect: function (t2) {
      ...
      const s3 =
          "clippingAncestors" === n3
            ? (function (t3, e3) {
                const n4 = e3.get(t3);
                if (n4) return n4;
                let i4 = D2(t3).filter((t4) => l2(t4) && "body" !== r2(t4)),
                  c4 = null;
        ...
        g3 = u3.reduce(
          (t3, n4) => {
            const o3 = W(e2, n4, c3);
            return (
              (t3.top = m2(o3.top, t3.top)),
              (t3.right = p2(o3.right, t3.right)),
              (t3.bottom = p2(o3.bottom, t3.bottom)),
              (t3.left = m2(o3.left, t3.left)),
              t3
            );
          },
          W(e2, d3, c3),
      ...
      return {
        width: g3.right - g3.left,
        height: g3.bottom - g3.top,
        x: g3.left,
        y: g3.top,
      };
    },
    convertOffsetParentRelativeRectToViewportRelativeRect: function (t2) {
      ...
      if (
        (i3 || (!i3 && "fixed" !== o3)) &&
        (("body" !== r2(n3) || f2(l3)) && (s3 = E2(n3)), c2(n3))
      ) {
        const t3 = R(n3);
        (u3 = b2(n3)),
      ...
      return {
        ...
        x: e2.x * u3.x - s3.scrollLeft * u3.x + a3.x,
        y: e2.y * u3.y - s3.scrollTop * u3.y + a3.y,
      };
    },
    isElement: l2,
    ...
    async getElementRects(t2) {
      ...
      const i3 = this.getOffsetParent || M,
        r3 = this.getDimensions;
      return {
        reference: P(e2, await i3(n3), o3),
...
(function () {
    ...
    switch (e.tagName) {
      ...
      case "LINK": {
        if (e.hasAttribute("rel") && e.hasAttribute("href"))
          return `link[rel="${e.getAttribute("rel")}"][href="${e.getAttribute(
            "href",
          )}"]`;
  ...
  function R(e, t) {
    ...
    for (let a of t.children) {
      let i = h(a),
        u = n.get(i);
      u ? N(a, false) !== N(u, false) && o.set(i, c(a)) : s.set(i, c(a)),
        n.delete(i);
    }
